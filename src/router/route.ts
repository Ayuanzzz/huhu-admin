...
export const dynamicRoutes: Array<RouteRecordRaw> = [
	{
		...
		children: [
			...
			},
			{
				...
				redirect: '/items/doing',
				meta: {
					title: 'message.router.items',
					isLink: '',
					isHide: false,
					isKeepAlive: true,
					isAffix: false,
				...
				children: [
					{
						path: '/items/plan',
						name: 'plan',
						component: () => import('/@/views/items/plan/index.vue'),
						meta: {
							title: 'message.router.plan',
							isLink: '',
							isHide: false,
							isKeepAlive: true,
							isAffix: false,
					...
					},
					{
						path: '/items/doing',
						name: 'doing',
						component: () => import('/@/views/items/doing/index.vue'),
						meta: {
							title: 'message.router.doing',
							isLink: '',
							isHide: false,
							isKeepAlive: true,
							isAffix: false,
					...
					},
					{
						path: '/items/done',
						name: 'done',
						component: () => import('/@/views/items/done/index.vue'),
						meta: {
							title: 'message.router.done',
							isLink: '',
							isHide: false,
							isKeepAlive: true,
							isAffix: false,
							isIframe: false,
							roles: ['admin', 'common'],
							icon: 'iconfont icon-30xuanzhongyuanxingfill',
						},
					},
				],
			},
